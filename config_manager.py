...
DYNAMIC_CONFIG_DEF = {
    ...
    constants.CONFIG_OPTION_MONITOR_RECONCILE_INTERVAL_MINUTES: (constants.CONFIG_SECTION_MONITOR, 'int', constants.DEFAULT_MONITOR_RECONCILE_INTERVAL_MINUTES),
    constants.CONFIG_OPTION_MONITOR_FULL_SCAN_INTERVAL_HOURS: (constants.CONFIG_SECTION_MONITOR, 'int', constants.DEFAULT_MONITOR_FULL_SCAN_INTERVAL_HOURS),
